...
<head>
  ...
  <title>Exemplo Arrays - Foreach</title>
</head>
<body>
  <div class=" w3-third w3-center w3-padding">
    <form class="w3-container" method="post" action="#">
      <label class="w3-text-teal"><strong>Nome do Cliente</strong></label>
      <input class="w3-input w3-border w3-lightgrey" name="txtNome" type="text">
      <label class="w3-text-teal"><strong>Valor da Compra</strong></label>
      <input class="w3-input w3-border w3-lightgrey" name="txtValorCompra" type="number">
      <label class="w3-text-teal"><strong>Estado para envio:</strong></label>
